...
final class Version20251121073713 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE plant ADD updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', CHANGE image_slug image_slug VARCHAR(255) DEFAULT NULL, CHANGE Watering_Frequency watering_frequency VARCHAR(50) DEFAULT NULL');
